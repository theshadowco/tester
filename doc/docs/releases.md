...
8. В экспериментальном режиме, добавлен расширенный редактор сценариев с подсветкой кода. Для проблемных окружений сохранен простой текстовый редактор, включаемый в настройках Тестера.
