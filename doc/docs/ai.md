...
Для таких сценариев полезны методы [ПолучитьГлавноеМеню](api.md#getmainmenu), [ПолучитьЭлементыАктивногоОкна](api.md#getactivewindowcontrols), [ПолучитьИзмененияОкна](api.md#getactivewindowchanges), [ВнестиЗначение](api.md#entervalue), [ПолучитьСодержимоеТаблицы](api.md#gettablecontent) и [ПолучитьСодержимоеТабличногоДокумента](api.md#getspreadsheetcontent).
