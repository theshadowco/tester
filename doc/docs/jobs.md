...
Для анализа результата по конкретному заданию или группе заданий можно использовать отчет `Сводка по заданиям`. Он показывает текущую сводку по сценариям в разрезе заданий и доступен как общий отчет, а также из контекста сценария или задания.
...
Запуск тестов по расписанию возможен за счет [механизма заданий](http://tester.help/#TasksDelegation) или настройки планировщика запуска программ средствами операционной системы.
