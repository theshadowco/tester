...
Пример:
    ...
    элементы = ПолучитьЭлементыАктивногоОкна ();
    ВСтудию ( Conversion.ToJSON ( элементы, false ) );
...
Пример:
    ...
    Нажать ( "#ФормаСоздать" );
    изменения = ПолучитьИзмененияОкна ();
    ВСтудию ( Conversion.ToJSON ( изменения, false ) );
...
Пример:
    ...
    меню = ПолучитьГлавноеМеню ();
    ВСтудию ( Conversion.ToJSON ( меню, false ) );
...
Пример:
    ...
    ВСтудию ( Conversion.ToJSON ( данные, false ) );
