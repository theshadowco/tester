...
Встроенный редактор сценариев поддерживает расширенный режим с подсветкой кода (пока в режиме бета-версии). Если в вашем окружении расширенный редактор работает нестабильно, в настройках Тестера можно включить простой текстовый редактор без подсветки. При написании большого количества сложных тестов по-прежнему можно использовать [интеграцию](vscode.md) с Visual Studio Code, особенно если сценарии хранятся в файловом репозитории.
