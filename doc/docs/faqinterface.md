...
В текущей версии Тестера встроенный редактор сценариев поддерживает расширенный режим с подсветкой кода. Если в конкретном окружении он работает нестабильно, в настройках можно включить простой текстовый редактор без подсветки.
