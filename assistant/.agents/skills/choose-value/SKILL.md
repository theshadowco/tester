...
2. Метод `Выбрать` как правило, открывает новую фору. Поэтому, заверши шаг строкой `возврат ПолучитьИзмененияОкна();`.
...
8. После закрытия формы выбора, рассматривай родительскую форму как активную и заверши шаг строкой `возврать ПолучитьЭлементыАктивногоОкна();`.
