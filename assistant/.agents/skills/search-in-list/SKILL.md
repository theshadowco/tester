...
3. Если форма предоставляет стандартное поле поиска, например `СписокСтрокаПоиска`, начни использовать его. Учитывай, что при вводе значения в сроку поиска, платформа сразу (как правило, дополнительно никаких кнопок нажимать не нужно) осуществляет поиск по всем видимым колонкам списка или таблицы.
